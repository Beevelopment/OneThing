...
func calulateTotalValue(amount: Double, yield: Double) -> String {
    let amountPerYear = amount * 12
    let totalValue = amountPerYear / yield
    let stringValue = String(totalValue)
